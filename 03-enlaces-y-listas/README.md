...
- [x] Un encabezado principal `<h1>` con el nombre de la ciudad y el atributo `id="inicio"`.
- [x] Una barra de navegación semántica `<nav aria-label="Navegación de la guía">` que contenga una lista `<ul>` con enlaces internos que salten a las diferentes secciones (`#lugares`, `#itinerario`, `#glosario`).
- [x] **Sección de Lugares de Interés (`#lugares`):**
...
- [x] **Enlaces externos y funcionales:**
