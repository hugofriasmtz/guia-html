...
- [ ] **Sección de Menú (`<section id="menu">`):**
...
- [ ] **Sección de Horarios y Ubicación (`<section id="horarios">`):**
  - Encabezado `<h2>`.
  - Párrafos estructurados con la dirección física y días de apertura.
- [ ] **Barra lateral o apéndice (`<aside id="chef">`):**
...
- [ ] **Calidad estructural:** Jerarquía de encabezados ordenada (`h1` $\rightarrow$ `h2` $\rightarrow$ `h3`) sin saltos de nivel y ausencia de "divitis" injustificada.
